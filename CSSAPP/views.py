...
""" def edit_profile(request):
    ...
    if request.method == 'POST':
        # Mettez à jour les champs du modèle avec les nouvelles valeurs
        ...
        if 'imagesprofiles' in request.FILES:
            image = request.FILES['imagesprofiles']
        ...
        return redirect('update_profile')  # Redirigez vers la page de détails après la modification
